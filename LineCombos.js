...
export default class LineCombos extends React.Component {
	...
	renderLineButton(teams, dfo, rank){
		...
		return(
			...
			? <React.Fragment>
					<table border='0' width='100%'>	
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[0], ranks[0])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[1], ranks[1])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[2], ranks[2])}
							</td>
						</tr>
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[3], ranks[3])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[4], ranks[4])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[5], ranks[5])}
							</td>
						</tr>
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[6], ranks[6])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[7], ranks[7])}							
							</td>
							<td>
								{this.renderLineButton(teams[2], names[8], ranks[8])}
							</td>
						</tr>
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[9], ranks[9])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[10], ranks[10])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[11], ranks[11])}
							</td>
						</tr>
						</table>
						<br/>
						...
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[12], ranks[12])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[13], ranks[13])}			
							</td>
						</tr>																
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[14], ranks[14])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[15], ranks[15])}		
							</td>
						</tr>	
						<tr>
							<td>
								{this.renderLineButton(teams[2], names[16], ranks[16])}
							</td>
							<td>
								{this.renderLineButton(teams[2], names[17], ranks[17])}	
							</td>
						</tr>					
					</table>
					</center>
